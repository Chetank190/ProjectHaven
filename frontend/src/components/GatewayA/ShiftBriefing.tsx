...
export function ShiftBriefing() {
  ...
  return (
    <div className="rounded-xl overflow-hidden" style={{ border: '1px solid #AADEED' }}>
      <button
        ...
        style={{ background: 'linear-gradient(90deg, #D5EFF5, #EFF9FB)', color: '#155F79' }}
      >
        <svg className="w-4 h-4 flex-shrink-0" style={{ color: '#1A7A9A' }} fill="currentColor" viewBox="0 0 20 20">
      ...
      {open && text && (
        <div className="px-4 py-3 text-sm leading-relaxed"
          style={{ background: '#EFF9FB', color: '#0A2A3D', borderTop: '1px solid #AADEED' }}>
          {text}
        </div>
      )}
    </div>
